...
Namespace Bind_a_Report_to_a_MongoDB_Instance
    ...
    Public Partial Class Form1
        ...
        Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Dim queryCategories = New MongoDBQuery() With {.DatabaseName = "Northwind", .CollectionName = "Categories"}
            ...
            Dim mongoDBDataSource = New MongoDBDataSource() With {.ConnectionParameters = connectionString}
            ' Create a report. Set the report's DataSource property
            ' to the created mongoDBDataSource object.
            Dim report = New XtraReport() With {.DataSource = mongoDBDataSource, .DataMember = "Categories"}
